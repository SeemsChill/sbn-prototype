...
const Section = () => {
    ...
    function signup() {
        signinRef.current.style.transform = 'translateX(-300%)';
    ...
    function signin() {
        ...
        signupRef.current.style.transform = 'translateX(-300%)';
        hrRef.current.style.transform = 'translateX(-100px)';
        ...
        <section className={section["section"]}>
            <Container>
                <div className={section["section__container"]}>
                    <Span callback={signin} spanRef={sgiRef}>Sign in</Span>
                    <Span callback={signup} spanRef={sguRef}>Sign up</Span>
                    <Hr hrRef={hrRef} />
